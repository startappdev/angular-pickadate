        ...
        .directive('pickadate', ['$locale', 'pickadateUtils', 'pickadateI18n', 'dateFilter', function ($locale, dateUtils, i18n, dateFilter) {
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    var minDate = scope.minDate && dateUtils.stringToDate(scope.minDate, dateFormat),
                        maxDate = scope.maxDate && dateUtils.stringToDate(scope.maxDate, dateFormat),
                        disabledDates = scope.disabledDates || [],
                        weekStartsOn = scope.weekStartsOn || 0,
                        noExtraRows = attrs.hasOwnProperty('noExtraRows'),
                        currentDate = (scope.defaultDate && dateUtils.stringToDate(scope.defaultDate, dateFormat)) || new Date();
                    ...
                    scope.render = function (initialDate) {
                        ...
                        var currentMonth = initialDate.getMonth() + 1,
                            ...
                            dates = [],
                            today = dateFilter(new Date(), 'yyyy-MM-dd'); // this format is good for before/after math...
                        ...
                        for (var i = 0; i < allDates.length; i++) {
                            ...
                            } else if (indexOf.call(disabledDates, dateObj) >= 0) {
                            ...
                            dates.push({date: dateStr, dateObj: dateObj, className: className});
                        }
                    ...
                    ngModel.$render = function () {
                        ...
                        if (date && (indexOf.call(disabledDates, date) === -1)) {
                            scope.currentDate = currentDate = dateUtils.stringToDate(date, dateFormat);
                        } else if (date) {
